...
exports.getCourse = asyncHandler( async (req,res,next) => {
    ...
    if(!course){
        next(new ErrorResponse(`No course found with the id of ${req.params.id}`,404));
    }
...
exports.createCourse = asyncHandler( async (req,res,next) => {
    ...
    if(!bootcamp){
        next(new ErrorResponse(`No bootcamp found with the id of ${req.params.bootcampId}`,404));
    }
